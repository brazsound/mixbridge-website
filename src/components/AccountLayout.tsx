...
export function AccountLayout() {
  ...
  return (
    <div className="pt-[73px] flex min-h-screen">
      {/* Sidebar */}
      <aside
        className="hidden md:flex flex-col w-60 shrink-0 border-r border-white/10 px-4 py-6 sticky top-[73px] h-[calc(100vh-73px)] overflow-y-auto"
      ...
      >
        ...
        <SidebarSection heading="Plan management" links={planLinks} />
        ...
        <div className="mt-auto pt-4 border-t border-white/10">
          <button
            ...
            className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium text-red-400 hover:bg-red-500/10 transition-colors w-full"
          >
      ...
      {/* Mobile nav bar */}
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 border-t border-white/10 bg-bg/95 backdrop-blur-xl px-2 py-1.5 flex justify-around">
